...
let comments = [];
document.getElementById('add-comment').onclick = function(e) {
  event.preventDefault();
  let commentName = document.getElementById('comment-name');
  let commentEmail = document.getElementById('email-name');
  let commentWebsite = document.getElementById('website-name');
  let commentBody = document.getElementById('textarea');

  let comment = {
    name: commentName.value,
    email: commentEmail.value,
    website: commentWebsite.value,
...
function showComments() {
  ...
  comments.forEach(function(item) {
    ...
    // out += `<p>${item.body}</p>`;
    out += `
    <div class="showcomments__info">
      <img src="/assets/Img1.png" alt="avatar">
      <p>Website</p>
    </div>
    <div class="showcomments-block">
      <div class="showcomments-block__header">
        <div class="showcomments-block__header-item">
          <div class="showcomments-block__header-name">${item.name}</div>
          <div class="showcomments-block__header-time">${item.time}</div>
        </div>
        <div class="showcomments-block__header-buttons">
          <a href="#"><svg width="18" height="16" viewBox="0 0 18 16" fill="none"
      ...
      <div class="showcomments-block__body">
        <p>${item.body} </p>
        <div class="heart">
          <svg width="23" height="21" viewBox="0 0 23 21" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M20.5922 1.88848C17.9957 -0.294719 13.9842 0.0332111 11.5 2.56231C9.01583 0.0332111 5.0043 -0.299211 2.40782 1.88848C-0.970307 4.73204 -0.476167 9.36798 1.93165 11.8252L9.81094 19.8527C10.2602 20.3109 10.8621 20.567 11.5 20.567C12.1424 20.567 12.7399 20.3154 13.1891 19.8572L21.0684 11.8297C23.4717 9.37247 23.9748 4.73653 20.5922 1.88848Z" fill="#474747"/>
            <path class="heartfocus" d="M19.532 10.3113L11.6527 18.3389C11.5449 18.4467 11.4551 18.4467 11.3473 18.3389L3.46797 10.3113C1.82833 8.64024 1.49591 5.47774 3.7959 3.54161C5.54337 2.07266 8.23868 2.29278 9.92774 4.01329L11.5 5.617L13.0723 4.01329C14.7703 2.28379 17.4656 2.07266 19.2041 3.53711C21.4996 5.47325 21.1582 8.65371 19.532 10.3113Z" fill="white"/>
            </svg>
            10
        </div>
      </div>
      <div class="showcomments-block__footer">
        ...
        <div class="answer__reaction">
          <div class="like">5<svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
